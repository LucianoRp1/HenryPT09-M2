...
// Tu código acá:
var nombre = "Luciano"
var api = 'Aplicación creada por '

   document.querySelector("#createdBy").innerHTML = api + nombre ;
...
function buildToDos(toDos) {
  // Tu código acá:
  var nuevoArray = toDos.map(buildToDo);
...
toDoContainer.innerHTML = "";
  var otraFuncion = buildToDos(toDoItems) ;
  for ( let i = 0 ; i < otraFuncion.length; i++){
    toDoContainer.appendChild(otraFuncion[i])
  }
...
// Tu código acá:
var agregarBoton = document.querySelector("#addButton");
